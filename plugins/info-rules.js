let handler = async (m, { conn }) => {
  ...
  if (m.sender.startsWith('62') || m.sender.startsWith('+62')) {
    var txt = `
(Indonesian)
**Ketentuan Layanan (TOS) - Kurumi-MD ESM**
Dengan menggunakan Kurumi-MD ESM, Anda setuju dengan ketentuan berikut:
...
Dengan menggunakan Kurumi-MD ESM, Anda setuju dengan semua ketentuan yang berlaku.
...
`
    ...
    txt = `
(English)
**Term of Service (TOS) - Kurumi-MD ESM**
By using Kurumi-MD ESM, you agree to the following terms:
...
By using Kurumi-MD ESM, you agree to abide by all applicable terms.
